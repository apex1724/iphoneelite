This is the iPhone kernel memory map (under 1.0.2). It is derived from pmaps. The names are from the ioreg command output and the IODeviceMemory properties.
